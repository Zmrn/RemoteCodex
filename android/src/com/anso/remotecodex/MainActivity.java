...
public final class MainActivity extends Activity {
  ...
  @Override protected void onResume(){super.onResume();foreground=true;widgetHandler.removeCallbacks(widgetPoll);widgetHandler.post(widgetPoll);if(app!=null){app.activity=new java.lang.ref.WeakReference<>(this);app.updates.foreground();}if(web!=null)web.onResume();if(pendingInstall&&getPackageManager().canRequestPackageInstalls()){pendingInstall=false;installUpdate();}}
