...
- 2026-09-10：0.10.28 通知排版/5 秒自动收起已双端发布、笔记本内置升级通过，设备与通知草稿保留、官方 PID 未变。198 Node、41 原生通知、13 窗口、最终包自检/强制重启及线上签名通过；未执行 APK、未进行真实两设备通知回复测试。最终哈希与范围见 NOTIFICATIONS.md。已合并另一设备 GitHub 构建提交并保留双远端；当前笔记本缺少 GitHub 登录，功能已推 Gitee，GitHub 待登录补推，不得记录为已同步。
