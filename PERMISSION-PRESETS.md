...
2026-09-22：修复 Remote Codex 选择内置权限时只更新访问配置、保留旧审批策略的问题。已于后续打包轮次随 0.10.45 经 GitHub 同次双端构建正式发布；更新目标 Windows 接入端后生效。包内复测与线上验收见 GITHUB-UPDATES.md，下文为源码阶段验证和官方恢复问题边界。
